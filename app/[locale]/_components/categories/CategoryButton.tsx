...
const CategoryButton: React.FC<Props> = ({ name, selectCategory }: Props) => {
    return(
        <button onClick={() => selectCategory(name)} className="flex-1 min-w-[120px] max-w-fit p-4 rounded-xl shadow-sm border border-slate-200 bg-white hover:bg-slate-50 hover:shadow-md 
